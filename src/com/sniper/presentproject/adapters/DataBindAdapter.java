...
abstract public class DataBindAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if(viewHolder instanceof UserProfileImageBinder.ViewHolder){
//        if(getDataBinder(viewHolder.getItemViewType()) instanceof UserProfileImageBinder){
//            ((UserProfileImageBinder)getDataBinder(0)).bindViewHolder((UserProfileImageBinder.ViewHolder)viewHolder,binderPosition);
            ((UserProfileImageBinder)getDataBinder(viewHolder.getItemViewType() - 1)).bindViewHolder((UserProfileImageBinder.ViewHolder)viewHolder,binderPosition);
//            ((UserProfileImageBinder)getDataBinder(viewHolder.getItemViewType())).bindViewHolder((UserProfileImageBinder.ViewHolder)viewHolder,binderPosition);
        }else if(viewHolder instanceof UserPostCardViewBinder.ViewHolder){
...
//            ((UserPostCardViewBinder)getDataBinder(1)).bindViewHolder((UserPostCardViewBinder.ViewHolder)viewHolder, binderPosition);
            ((UserPostCardViewBinder)getDataBinder(viewHolder.getItemViewType() -1 )).bindViewHolder((UserPostCardViewBinder.ViewHolder)viewHolder, binderPosition);
